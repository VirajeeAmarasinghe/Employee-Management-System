...
import databaseConnection.ClientDB;
...
public class Client extends javax.swing.JFrame {
    ...
    private ArrayList<ClientInfo> arrayListClient;
    ...
    public Client() {
        ...
        cdb = new ClientDB();
        txt_clientID.setText(cdb.getNextID() + "");
        txt_name.grabFocus();
        setAccessPrivileges();
    }
    ...
    //this method is for validating text fields
    private boolean isValidForm() {
        Validator v = new Validator();
        if (!v.isPresent(txt_clientID, "Client ID")) {
            return false;
        }
        if (!v.isPresent(txt_name, "Client Name")) {
            return false;
        }
        ...
        if (!v.isPresent(txt_nic, "NIC No")) {
            return false;
        }
        if (!v.isPresent(txt_tele, "Telephone No")) {   //Filling E-mail field is not compulsary
            return false;
        }
        ...
        if (!v.isInteger(txt_clientID, "Client ID")) {
            return false;
        }
        return true;
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("No:");
        pnl_third.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, -1, -1));
        ...
        pnl_third.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, -1, -1));
        ...
        pnl_third.add(txt_addNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 170, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("City:");
        pnl_third.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 170, -1, -1));
        ...
        pnl_third.add(txt_addCity, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 170, 170, -1));
        ...
        pnl_third.add(txt_addStreet, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 140, 170, -1));

        jLabel4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        pnl_third.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 240, 110));

        jLabel8.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Telephone:");
        pnl_third.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, -1, -1));

        jLabel9.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("NIC No:");
        pnl_third.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("E-mail:");
        pnl_third.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, -1));

        txt_clientID.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txt_clientIDKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_clientIDKeyTyped(evt);
            }
        });
        pnl_third.add(txt_clientID, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 20, 160, -1));
        ...
        pnl_third.add(txt_name, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 50, 160, -1));

        txt_nic.setToolTipText("NIC No Format:XXXXXXXXXV");
        ...
        pnl_third.add(txt_nic, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 170, -1));

        txt_tele.setToolTipText("Tele format:XXX-XXXXXXX");
        ...
        pnl_third.add(txt_tele, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, 170, -1));
        ...
        pnl_third.add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 170, -1));
        ...
        pnl_third.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 400, 100));
        ...
        pnl_third.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, -1, 30, 30));
        ...
        pnl_third.add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 50, 100, -1));
        ...
        pnl_third.add(btn_del, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, 100, -1));
        ...
        pnl_third.add(btn_findID, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, 100, -1));
        ...
        pnl_third.add(btn_edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, 100, -1));
        ...
        pnl_third.add(btn_display, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 270, 100, -1));
        ...
        pnl_third.add(btn_clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 310, 100, -1));
        ...
        pnl_third.add(btn_findName, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 220, 100, -1));

        jLabel11.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Find", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
        pnl_third.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 130, 90));
        ...
        pnl_third.add(btn_print, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, -1, -1));

        pnl_second.add(pnl_third, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 420, 460));

        pnl_main.add(pnl_second, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 440, 480));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnl_main, javax.swing.GroupLayout.DEFAULT_SIZE, 460, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(pnl_main, javax.swing.GroupLayout.PREFERRED_SIZE, 498, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_displayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_displayActionPerformed
        dtm.setRowCount(0);
        ArrayList<ClientInfo> ar = cdb.getAllDataFromDB();
        if (ar != null) {
            for (ClientInfo cl : ar) {
                int cId = cl.getcId();
                String cName = cl.getcName();
                String addNo = cl.getAddNo();
                String addStreet = cl.getAddStreet();
                String addCity = cl.getAddCity();
                String nic = cl.getNic();
                String tele = cl.getTele();
                String email = cl.getEmail();
                dtm.addRow(new Object[]{cId, cName, addNo, addStreet, addCity, nic, tele, email});
            }
        }
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        if (isValidForm()) {
            ClientInfo cl = new ClientInfo(Integer.parseInt(txt_clientID.getText()), txt_name.getText(), txt_addNo.getText(), txt_addStreet.getText(), txt_addCity.getText(), txt_nic.getText(), txt_tele.getText(), txt_email.getText());
            int result = cdb.addData(cl);
            if (result == 1) {
                JOptionPane.showMessageDialog(btn_add, "New Client added successfully");
                clearFields();
                txt_clientID.setText(cdb.getNextID() + "");
            } else if (result == 0) {
                JOptionPane.showMessageDialog(btn_add, "Some Error Occurred.New Client was not added");
            }
        }
    ...
    private void txt_nicKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_nicKeyTyped
        ...
        if (txt_nic.getText().length() > 9) {  //nic no only contains 10 characters
            evt.consume();
        }
    ...
    private void txt_teleKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_teleKeyTyped
        ...
        if (txt_tele.getText().length() > 10) {  //valid telephone no contains only contains 11 characters including '-' mark.
            evt.consume();
        }
    ...
    private void btn_findIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_findIDActionPerformed
        String input = JOptionPane.showInputDialog("Enter Valid Client ID");
        if (input != null) {
            int cID = Integer.parseInt(input);
            ClientInfo c = cdb.getDataById(cID);
            if (c != null) {
                txt_clientID.setText(cID + "");
                txt_name.setText(c.getcName());
                txt_addNo.setText(c.getAddNo());
                txt_addStreet.setText(c.getAddStreet());
                txt_addCity.setText(c.getAddCity());
                txt_nic.setText(c.getNic());
                txt_tele.setText(c.getTele());
    ...
    private void btn_delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_delActionPerformed
        String input = JOptionPane.showInputDialog("Enter Valid Client ID");
        if (input != null) {  //this if statement handles NullPointerException
            int inputYesNo = JOptionPane.showConfirmDialog(btn_del, "Are U Sure U want to delete this Record?");
            if (inputYesNo == 0) {
                int cID = Integer.parseInt(input);
                int result = cdb.deleteData(cID);
                if (result == 1) {
                    JOptionPane.showMessageDialog(btn_del, "Client deleted successfully");
                    clearFields();
                    txt_clientID.setText(cdb.getNextID() + "");
                } else if (result == 0) {
                    JOptionPane.showMessageDialog(btn_del, "Client not deleted.Some Error Occurred.");
                }
            }
        }
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        if (isValidForm()) {
            ClientInfo clinfo;
            int cID = Integer.parseInt(txt_clientID.getText());
            ...
            clinfo = new ClientInfo(cID, name, addNo, addStreet, addCity, nic, tele, mail);

            int result = cdb.editData(clinfo);
            if (result == 1) {
                JOptionPane.showMessageDialog(btn_edit, "Client edited successfully");
                clearFields();
                txt_clientID.setText(cdb.getNextID() + "");
            } else if (result == 0) {
                JOptionPane.showMessageDialog(btn_edit, "Client not edited.Some Error Occurred.");
            }
        }
    ...
    private void btn_clearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_clearActionPerformed
        clearFields();
        txt_clientID.setText(cdb.getNextID() + ""); //this set next client id in the text field.
        int i = tblClient.getRowCount();
        for (int j = 0; j < i; j++) {  //this for loop for removing rows in the table one by one
            dtm.removeRow(0);
        }
        txt_name.grabFocus();
    ...
    private void txt_clientIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_clientIDKeyPressed
    ...
    }//GEN-LAST:event_txt_clientIDKeyPressed
    ...
    private void tblClientMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientMouseClicked
        ...
        String nic = (String) dtm.getValueAt(i, 5);
        String tele = (String) dtm.getValueAt(i, 6);
        String mail = (String) dtm.getValueAt(i, 7);

        txt_addNo.setText(id + "");
    ...
    private void btn_findNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_findNameActionPerformed
        String input = JOptionPane.showInputDialog("Enter Valid Client Name");
        dtm.setRowCount(0);
        if (input != null) {
            ArrayList<ClientInfo> ar = cdb.getDataByName(input);
            if (ar != null) {
                for (ClientInfo cl : ar) {
                    int cId = cl.getcId();
                    String cName = cl.getcName();
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
        MessageFormat header = new MessageFormat("Details of all the Clients");
